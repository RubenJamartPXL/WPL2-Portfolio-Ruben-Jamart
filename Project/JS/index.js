document.addEventListener("DOMContentLoaded", function () {
    ...
    function nederlands() {
        ...
        textpop.textContent = "Het begon bij de verschillende POP sessies.\n" +
            ...
            "Mijn hard skills zijn verschillende tools zoals Photoshop, Illustrator, Premiere Pro, After Effects, deze heb ik pas geleerd tijdens de lessen Graphics Skills en in mijn vrije tijd, maar ook programmeertalen zoals HTML, CSS, Java, C++, C#, PHP, SQL, ..., maar deze bezat ik al. Ik\n" +
